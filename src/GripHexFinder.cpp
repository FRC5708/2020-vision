...
void GripHexFinder::Process(cv::Mat& source0){
	...
	double hslThresholdLuminance[] = {224.73021582733816, 255.0};
 ...
 */
std::vector<std::vector<cv::Point> >* GripHexFinder::GetFilterContoursOutput(){
...
std::vector<std::vector<cv::Point> >* GripHexFinder::GetConvexHullsOutput(){
	 ...
	 */
	void GripHexFinder::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
